<?php
    ...
    $PRINTER_NAME = "XP58_ZE";

    $KEY_PAGE = "ARC0IRIS123RBTECV0C123";

    $SERVER_LOCAL_ADDR = "http://192.168.1.68/printTicket/printAdm.php?";
    // $RETURN_URL_FINAL = "'http://arocoiris.com/adm/sales'";
    $RETURN_URL_FINAL = "'http://localhost/elarcoiris/adm/sales'";
    function valorEnLetras($x) { 
        ...
        if($G7==1 && $G8==0) { $H7 = "Cien "; } 
        else {    $H7 = decenas($G7); } 
        
        $H8 ="";
        if (($H7 == "" AND $G8 > 1) OR ($H7 != "")){
            $H8 = unidades($G8); 
        }
        
        if($G9==1 && $G10==0) { $H9 = "Cien "; } 
        else {    $H9 = decenas($G9); } 
